...
<div class="m-grid m-grid--hor m-grid--root m-page">
	<div class="m-grid__item m-grid__item--fluid m-grid  m-error-1" style="background-image: url(public/app/media/img//error/bg1.jpg);">
...
<script src="public/demo/default/base/scripts.bundle.js" type="text/javascript"></script>
