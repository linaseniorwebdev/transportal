								...
								<li class="m-nav__item m-topbar__user-profile m-topbar__user-profile--img  m-dropdown m-dropdown--medium m-dropdown--arrow m-dropdown--header-bg-fill m-dropdown--align-right m-dropdown--mobile-full-width" m-dropdown-toggle="click">
									<a href="javascript:;" class="m-nav__link m-dropdown__toggle">
										<span class="m-topbar__userpic">
											<img src="public/app/media/img/users/user3.jpg" class="m--img-rounded m--marginless" alt="" />
										</span>
											...
											<div class="m-dropdown__header m--align-center" style="background: url(public/app/media/img/misc/user_profile_bg.jpg); background-size: cover;">
												<div class="m-card-user m-card-user--skin-dark">
													...
													<div class="m-card-user__details">
														<span class="m-card-user__name m--font-weight-500"><?php echo $firstname; ?> <?php echo $lastname; ?></span>
			...
			<div id="m_ver_menu" class="m-aside-menu m-aside-menu--skin-dark m-aside-menu--submenu-skin-dark " m-menu-vertical="1" m-menu-scrollable="1" m-menu-dropdown-timeout="500" style="position: relative;">
				<ul class="m-menu__nav m-menu__nav--dropdown-submenu-arrow ">
					<li class="m-menu__item<?php if ($command == 'index') echo ' m-menu__item--active'; ?>" aria-haspopup="true">
						<a href="<?php if ($command == 'index') echo 'javascript:;'; else echo base_url('manager'); ?>" class="m-menu__link ">
					...
					<li class="m-menu__item m-menu__item--submenu<?php if ($command == 'media') echo ' m-menu__item--open'; ?>" aria-haspopup="true" m-menu-submenu-toggle="hover">
						<a href="javascript:;" class="m-menu__link m-menu__toggle">
							<i class="m-menu__link-icon flaticon-multimedia-3"></i>
							<span class="m-menu__link-text">My Media</span>
							<i class="m-menu__ver-arrow la la-angle-right"></i>
						</a>
						<div class="m-menu__submenu ">
							<span class="m-menu__arrow"></span>
							<ul class="m-menu__subnav">
								<li class="m-menu__item<?php if ($command == 'media' && $subcomm == 'all') echo ' m-menu__item--active'; ?>" aria-haspopup="true">
									<a href="<?php if ($command == 'media' && $subcomm == 'all') echo 'javascript:;'; else echo base_url('manager/media/all'); ?>" class="m-menu__link ">
										<i class="m-menu__link-bullet m-menu__link-bullet--dot">
											<span></span>
										</i>
										<span class="m-menu__link-text">All My Media</span>
									</a>
								</li>
								<li class="m-menu__item<?php if ($command == 'media' && $subcomm == 'new') echo ' m-menu__item--active'; ?>" aria-haspopup="true">
									<a href="<?php if ($command == 'media' && $subcomm == 'new') echo 'javascript:;'; else echo base_url('manager/media/new'); ?>" class="m-menu__link ">
										<i class="m-menu__link-bullet m-menu__link-bullet--dot">
											<span></span>
										</i>
										<span class="m-menu__link-text">New Upload</span>
									</a>
								</li>
							</ul>
						</div>
					</li>
					<li class="m-menu__item<?php if ($command == 'messages') echo ' m-menu__item--active'; ?>" aria-haspopup="true">
						<a href="<?php if ($command == 'messages') echo 'javascript:;'; else echo base_url('manager/messages'); ?>" class="m-menu__link ">
