        ...
        t.fn.mDatatable = function(n) {
            if (0 !== t(this).length) {
                ...
                var i = {
                    ...
                    layoutUpdate: function() {
                        i.setupSubDatatable.call(), i.setupSystemColumn.call(), i.setupHover.call(), void 0 === n.detail && 1 === i.getDepth() && i.lockTable.call(), i.columnHide.call(), i.resetScroll(), i.isInit || (t(o).trigger("m-datatable--on-init", {
                            ...
                            options: n
                        }), i.isInit = !0), t(o).trigger("m-datatable--on-layout-updated", {
                            table: t(o.wrap).attr("id")
                        })
                    },
                    lockTable: function() {
                            ...
                            enable: function() {
                                t(o.table).find("thead,tbody,tfoot").each(function() {
                                    ...
                                    0 === t(this).find(".m-datatable__lock").length && t(this).ready(function() {
                                        ! function(a) {
                                            if (t(a).find(".m-datatable__lock").length > 0) i.log("Locked container already exist in: ", a);
                    ...
                    initScrollbar: function(a, n) {
                        if (t(o.tableBody).css("overflow", ""), e.hasClass(a, "ps")) t(a).data("ps").update();
                        else {
                    ...
                    dataRender: function(e) {
                        ...
                        var a = function() {
                            ...
                            l = function(e) {
                                ...
                                if (t(o.wrap).removeClass("m-datatable--error"), n.pagination)
                    ...
                    autoHide: function() {
                        ...
                        var e = function(e) {
                            ...
                            var a = t(this).closest(".m-datatable__row"),
                                o = t(a).next();
                            if (t(o).hasClass("m-datatable__row-detail")) t(this).find("i").removeClass(i.getOption("layout.icons.rowDetail.expand")).addClass(i.getOption("layout.icons.rowDetail.collapse")), t(o).remove();
                            else {
                    ...
                    sortColumn: function(e, a, n) {
                        ...
                        var i = t(e).index(),
                            ...
                            r = t(e).closest(".m-datatable__lock").index(); - 1 !== r && (l = t(o.tableBody).find(".m-datatable__lock:nth-child(" + (r + 1) + ")").find(".m-datatable__row"));
                        var s = t(l).parent();
                    ...
                    visible: function(e) {
                        if (t(i.recentNode.length)) {
                            ...
                            e ? (i.recentNode === i.nodeCols && delete n.columns[o].responsive, t(i.recentNode).show()) : (i.recentNode === i.nodeCols && i.setOption("columns." + o + ".responsive", {
                                hidden: "xl"
                            }), t(i.recentNode).hide()), i.redraw()
                        }
                    },
                    nodes: function() {
                        return i.recentNode
                ...
                if (t.each(i, function(t, e) {
                    ...
                    }, n = t.extend(!0, {}, t.fn.mDatatable.defaults, n), o.options = n, i.init.apply(this, [n]), t(o.wrap).data("mDatatable", o));
                else void 0 === (o = t(this).data("mDatatable")) && t.error("mDatatable not initialized"), n = o.options;
                return o
            }
